...
trait GQLManhattanAssociation {
  ...
  val manhattanAssociation: ObjectType[Backend, ManhattanAssociation] =
    deriveObjectType[Backend, ManhattanAssociation](
      ExcludeFields("v2dOdds",
                    "v2dBeta",
                    "variantId",
                    "pval",
                    "bestGenes",
      ...
      AddFields(
        ...
        Field("bestColocGenes",
              ListType(scoredGene),
              Some("A list of best genes associated"),
              resolve = _.value.bestColocGenes
        ),
        Field("bestLocus2Genes",
              ListType(scoredGene),
