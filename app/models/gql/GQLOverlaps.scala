...
trait GQLOverlaps {
  ...
  implicit val overlappedVariant: ObjectType[Backend, OverlappedVariant] =
    deriveObjectType[Backend, OverlappedVariant](
  ...
  val overlappedStudy: ObjectType[Backend, OverlapRow] = ObjectType(
    ...
    fields[Backend, OverlapRow](
      Field("studyId", StringType, Some("A study object"), resolve = rsl => rsl.value.stid),
      Field("study",
            OptionType(study),
            Some("A study object"),
  ...
  val overlappedVariantsStudies: ObjectType[Backend, OverlappedVariantsStudy] =
    deriveObjectType[Backend, OverlappedVariantsStudy](
